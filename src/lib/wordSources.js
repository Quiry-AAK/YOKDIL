...
export function buildWordGroups(words, dailyWords = [], dailyWordsHistory = [], extractedWords = []) {
  ...
  return [
    ...
    { key: "denemeler", label: "Denemelerden Çıkarılan Kelimeler", pool: words.filter((w) => extractedSet.has(w.word)) },
